...
#define ENDER_AIO_VERSION 20250927
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3 AIO)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME ENDER_AIO_CUSTOM_PRINTER_NAME
...
#define TEMP_SENSOR_BOARD ENDER_AIO_TEMP_SENSOR_BOARD
#define TEMP_SENSOR_SOC ENDER_AIO_TEMP_SENSOR_SOC
...
#define HEATER_0_MAXTEMP ENDER_AIO_HEATER_0_MAXTEMP
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Ender-3
    #define DEFAULT_Kp ENDER_AIO_DEFAULT_Kp
    #define DEFAULT_Ki ENDER_AIO_DEFAULT_Ki
    #define DEFAULT_Kd ENDER_AIO_DEFAULT_Kd
  #endif
#else
 ...
 */
  ...
  #define MPC_HEATER_POWER { ENDER_AIO_CUSTOM_MPC_HEATER_POWER }                  // (W) Nominal heat cartridge powers.
  ...
  #define MPC_BLOCK_HEAT_CAPACITY ENDER_AIO_CUSTOM_MPC_BLOCK_HEAT_CAPACITY // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS ENDER_AIO_CUSTOM_MPC_SENSOR_RESPONSIVENESS  // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF ENDER_AIO_CUSTOM_MPC_AMBIENT_XFER_COEFF  // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 ENDER_AIO_CUSTOM_MPC_AMBIENT_XFER_COEFF_FAN255  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM ENDER_AIO_CUSTOM_FILAMENT_HEAT_CAPACITY_PERMM // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define PIDTEMPBED
  ...
  // Ender-3
  #define DEFAULT_bedKp ENDER_AIO_DEFAULT_bedKp
  #define DEFAULT_bedKi ENDER_AIO_DEFAULT_bedKi
  #define DEFAULT_bedKd ENDER_AIO_DEFAULT_bedKd
...
#define Z_MIN_ENDSTOP_HIT_STATE ENDER_AIO_Z_MIN_ENDSTOP_HIT_STATE
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE ENDER_AIO_Z_MIN_PROBE_ENDSTOP_HIT_STATE
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, ENDER_AIO_E_STEPS_PER_UNIT }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET ENDER_AIO_NOZZLE_TO_PROBE_OFFSET
...
#define INVERT_X_DIR ENDER_AIO_INVERT_X_DIR
#define INVERT_Y_DIR ENDER_AIO_INVERT_Y_DIR
#define INVERT_Z_DIR ENDER_AIO_INVERT_Z_DIR
...
#define INVERT_E0_DIR ENDER_AIO_INVERT_E0_DIR
...
#define HOMING_FEEDRATE_MM_M ENDER_AIO_HOMING_FEEDRATE_MM_M
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL ENDER_AIO_PRINTCOUNTER_SAVE_INTERVAL  // (minutes) EEPROM save interval during print. A value of 0 will save stats at end of print.
#endif
 ...
 */
#define LCD_LANGUAGE ENDER_AIO_LCD_LANGUAGE
