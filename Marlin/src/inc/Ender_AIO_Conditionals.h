...
// Define MOTHERBOARD here so preflight-checks.py works
  ...
  #define FAN_SOFT_PWM
  #define ENDER_AIO_SINGLE_EXP_CONNECTION 1
...
// PRINTCOUNTER
#if ENABLED(ENDER_AIO_HAS_REAL_EEPROM)
  #define ENDER_AIO_PRINTCOUNTER_SAVE_INTERVAL 60  // Save stats every hour
#else
  #define ENDER_AIO_PRINTCOUNTER_SAVE_INTERVAL  0  // Save stats at end of print to prevent potential lost steps during printing
#endif
...
// Extruder Steps/mm
#if defined(ENDER_AIO_E_STEPS_PER_UNIT_CUSTOM)
  #define ENDER_AIO_E_STEPS_PER_UNIT ENDER_AIO_E_STEPS_PER_UNIT_CUSTOM
  ...
  #define ENDER_AIO_E_STEPS_PER_UNIT 142
#elif ANY(ENDER_AIO_EXTRUDER_TL_DDB_V2, ENDER_AIO_EXTRUDER_BONDTECH_BMG)
  #define ENDER_AIO_E_STEPS_PER_UNIT 415
#endif

// Default Extruder Inverting
#if ANY(ENDER_AIO_EXTRUDER_STOCK, ENDER_AIO_EXTRUDER_WINSINN_DUAL_GEAR, ENDER_AIO_EXTRUDER_TL_DDB_V2)
  #define ENDER_AIO_INVERT_E0_DIR true
#elif ENABLED(ENDER_AIO_EXTRUDER_BONDTECH_BMG)
...
// X inverting
#if ENABLED(ENDER_AIO_INVERT_X_DIR)
  #define ENDER_AIO_INVERT_X_DIR false
#else // Stock
  #define ENDER_AIO_INVERT_X_DIR true
#endif

// Y inverting
#if ENABLED(ENDER_AIO_INVERT_Y_DIR)
  #define ENDER_AIO_INVERT_Y_DIR false
#else // Stock
  #define ENDER_AIO_INVERT_Y_DIR true
#endif

// Z inverting
#if ENABLED(ENDER_AIO_INVERT_Z_DIR)
  #define ENDER_AIO_INVERT_Z_DIR true
#else // Stock
...
#if ENABLED(ENDER_AIO_PHAETUS_DRAGONFLY_290C)
  #define ENDER_AIO_HEATER_0_MAXTEMP 305 // 290 + 15 = 305
#else
   #define ENDER_AIO_HEATER_0_MAXTEMP 270 // 255 + 15 = 270
#endif

// Motherboard Thermistor
#if ENABLED(ENDER_AIO_HAS_TEMP_SENSOR_BOARD)
  #define ENDER_AIO_TEMP_SENSOR_BOARD 1
#else
  #define ENDER_AIO_TEMP_SENSOR_BOARD 0
#endif

// SOC Temperature
#if ENABLED(ENDER_AIO_HAS_TEMP_SENSOR_SOC)
  #define ENDER_AIO_TEMP_SENSOR_SOC 100
#else
  #define ENDER_AIO_TEMP_SENSOR_SOC 0
#endif
...
//===========================================================================
  ...
  #define PROBE_OFFSET_WIZARD
    ...
    #define ENDER_AIO_NOZZLE_TO_PROBE_OFFSET { -40, -9, -0.0 }
  #elif ENABLED(ENDER_AIO_BLTOUCH_MOUNT_DUDE_IN_A_BOX)
    #define ENDER_AIO_NOZZLE_TO_PROBE_OFFSET { -43, -10, -0.0 }
...
// Only enable TFT serial port when needed
#if ENABLED(ENDER_AIO_DISPLAY_BTT_TFT35_E3_TFT)
  #define SERIAL_PORT_2 ENDER_AIO_SERIAL_PORT_2
  #define EP_BABYSTEPPING  // M293/M294 babystepping with EMERGENCY_PARSER support
#endif

#if ENABLED(ENDER_AIO_USES_BOTH_EXP_CABLES) && DISABLED(ENDER_AIO_SINGLE_EXP_CONNECTION)
...
//#define ENDER_AIO_CALIBRATION_MENU
  ...
  #if ALL(ENDER_AIO_BLTOUCH, ENDER_AIO_HAS_FIVE_DRIVERS, ENDER_AIO_DUAL_Z_KIT)
