...
//===========================================================================
  ...
  #define ENDER_AIO_Z_MIN_ENDSTOP_HIT_STATE HIGH
#endif // ANY(ENDER_AIO_BLTOUCH, ENDER_AIO_MICROPROBE)
...
// Sheet Profiles Menu
#if ENABLED(ENDER_AIO_SHEET_PROFILES_MENU) && ANY(ENDER_AIO_BLTOUCH, ENDER_AIO_MICROPROBE)
...
//#define ENDER_AIO_CALIBRATION_MENU
  ...
  #if ALL(ENDER_AIO_HAS_FIVE_DRIVERS, ENDER_AIO_DUAL_Z_KIT) && ANY(ENDER_AIO_BLTOUCH, ENDER_AIO_MICROPROBE)
