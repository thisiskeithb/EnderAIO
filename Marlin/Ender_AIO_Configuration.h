 ...
 *
 * Note: If your motherboard supports five drivers, all five driver slots should be populated (TMC2209s).
 */
...
// Custom E-Steps
//#define ENDER_AIO_E_STEPS_PER_UNIT_CUSTOM 93
 ...
 * BLTouch
 *
 * Don't forget to remove Z endstop!
 *
...
//#define ENDER_AIO_BLTOUCH
   ...
   * BLTouch Connection
   *
   * Connected to ZPROBE (5-pin) or SERVO (3-pin) + ZPROBE (2-pin) by default.
   */
  //#define ENDER_AIO_PROBE_CONNECTED_TO_Z_MIN_PORT             // Uncomment if connecting to Z MIN/Z STOP instead.
#endif
 ...
 * Bed Leveling Type
 *
 *   - Mesh Bed Leveling (assumed if BLTouch enabled above)
 *   - Bilinear
...
//#define ENDER_AIO_DISPLAY_BTT_TFT35_E3_TFT
  ...
  #define ENDER_AIO_USES_BOTH_EXP_CABLES  // Enable if using both EXP cables. SD Card connection will be set to the TFT.
#endif
...
//#define ENDER_AIO_INPUT_SHAPING
  ...
  #define ENDER_AIO_SHAPING_ZETA_X  0.15f  // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #define ENDER_AIO_SHAPING_ZETA_Y  0.15f  // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
#endif
...
#if ALL(ENDER_AIO_SHEET_PROFILES_MENU, ENDER_AIO_BLTOUCH)
