...
//#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN ENDER_AIO_CONTROLLER_FAN_PIN // Set a custom pin for the controller fan
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {X_CENTER, Y_CENTER }, { 32, 32 }, { 203,  32 }, { 203, 203 }, { 32, 203 } }
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  ENDER_AIO_SHAPING_FREQ_X  // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  ENDER_AIO_SHAPING_ZETA_X  // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  ENDER_AIO_SHAPING_FREQ_Y  // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  ENDER_AIO_SHAPING_ZETA_Y  // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_CONNECTION ENDER_AIO_SDCARD_CONNECTION
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define E0_CURRENT      ENDER_AIO_E0_CURRENT
